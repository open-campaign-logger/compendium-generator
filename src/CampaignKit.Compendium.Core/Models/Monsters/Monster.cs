// <copyright file="Monster.cs" company="Jochen Linnemann - IT-Service">
...
namespace CampaignKit.Compendium.Core.Models.Monsters
{
    ...
    /// <summary>
    /// This class is used to represent a monster.
    /// </summary>
    public class Monster
    {
        ...
        /// <summary>
        /// Gets or sets name of the monster.  Example: Aboleth.
        /// </summary>
        public string Name { get; set; } = string.Empty;

        /// <summary>
        /// Gets or sets size of the monster.  Example: Large.
        /// </summary>
        public string Size { get; set; } = string.Empty;

        /// <summary>
        /// Gets or sets type of the monster.  Example: aberration.
        /// </summary>
        public string Type { get; set; } = string.Empty;

        /// <summary>
        /// Gets or sets alignment of the monster.  Example: lawful evil.
        /// </summary>
        public string Alignment { get; set; } = string.Empty;

        /// <summary>
        /// Gets or sets source document of the monster data.
        /// </summary>
        public string SourceDocumentTitle { get; set; } = string.Empty;

        /// <summary>
        /// Gets or sets source document descrition associated with the monster data.
        /// </summary>
        public string SourceDocumentDescription { get; set; } = string.Empty;

        /// <summary>
        /// Gets or sets version of the source document associated with the monster data.
        /// </summary>
        public string SourceDocumentVersion { get; set; } = string.Empty;

        /// <summary>
        /// Gets or sets name of the license associated with the monster data.
        /// </summary>
        public string LicenseName { get; set; } = string.Empty;

        /// <summary>
        /// Gets or sets author of the monster data.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets copyright associated with the monster data.
        /// </summary>
        public string Copyright { get; set; } = string.Empty;

        /// <summary>
        /// Gets or sets license URL associated with the monster data.
        /// </summary>
        public string LicenseURL { get; set; } = string.Empty;

        /// <summary>
        /// Gets or sets rule system associated with the monster data.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets armor class of the monster.  Example: 17.
        /// </summary>
        public int ArmorClass { get; set; } = 0;

        /// <summary>
        /// Gets or sets type of armor worn by the monster.  Example: natural armor.
        /// </summary>
        public string ArmorDesc { get; set; } = string.Empty;

        /// <summary>
        /// Gets or sets average hit points of the monster.  Example 135.
        /// </summary>
        public int HitPoints { get; set; } = 0;

        /// <summary>
        /// Gets or sets hit dice calculation for the monster.  Example 18d10+36.
        /// </summary>
        public string HitDice { get; set; } = string.Empty;

        /// <summary>
        /// Gets or sets walking speed of the monster in feet per round.  Example 10.
        /// </summary>
        public int Walk { get; set; } = 0;

        /// <summary>
        /// Gets or sets swimming speed of the monster in feet per round.  Example 40.
        /// </summary>
        public int Swim { get; set; } = 0;

        /// <summary>
        /// Gets or sets swimming speed of the monster in feet per round.  Example 0.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether ability of the monster to hover.  Example: false.
        /// </summary>
        public bool Hover { get; set; } = false;

        /// <summary>
        /// Gets or sets light walking capability of the monster to hover.  Example: 80.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets strength of the monster.  Example: 21.
        /// </summary>
        public int Strength { get; set; } = 0;

        /// <summary>
        /// Gets or sets dexterity of the monster.  Example: 9.
        /// </summary>
        public int Dexterity { get; set; } = 0;

        /// <summary>
        /// Gets or sets constitution of the monster.  Example: 15.
        /// </summary>
        public int Constitution { get; set; } = 0;

        /// <summary>
        /// Gets or sets intelligence of the monster.  Example: 18.
        /// </summary>
        public int Intelligence { get; set; } = 0;

        /// <summary>
        /// Gets or sets wisdom of the monster.  Example: 15.
        /// </summary>
        public int Wisdom { get; set; } = 0;

        /// <summary>
        /// Gets or sets charisma of the monster.  Example: 18.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets strength saving throw of the monster.
        ...
        /// <summary>
        /// Gets or sets dexterity saving throw of the monster.
        /// Leave zero if monster does not have the saving throw specified.
        /// Example: 0.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets constitution saving throw of the monster.
        /// Leave zero if monster does not have the saving throw specified.
        /// Example: 15.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets intelligence saving throw of the monster.
        /// Leave zero if monster does not have the saving throw specified.
        /// Example: 8.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets wisdom saving throw of the monster.
        /// Leave zero if monster does not have the saving throw specified.
        /// Example: 6.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets charisma saving throw of the monster.
        /// Leave zero if monster does not have the saving throw specified.
        /// Example: 0.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets distance in feet that the monster can see with darkvision.
        ...
        /// <summary>
        /// Gets or sets distance in feet that the monster can see with blindsight.
        /// Leave 0 if not specified.
        /// Example 0.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets distance in feet that the monster can see with truesight.
        /// Leave 0 if not specified.
        /// Example 0.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets distance in feet that the monster can feel with tremorsense.
        /// Leave 0 if not specified.
        /// Example 0.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets languages the monster is able to speak or understand.  Example Deep Speech, telepathy 120 ft.
        /// </summary>
        public string Languages { get; set; } = string.Empty;

        /// <summary>
        /// Gets or sets the challenge rating of th monster.  Fractional CRs should be expressed as a decimal.  Example: 10.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets damage vulnerabilities belonging to the monster.  Example: Thunder.
        /// </summary>
        public string DamageVulnerabilities { get; set; } = string.Empty;

        /// <summary>
        /// Gets or sets damage resistances belonging to the monster.  Example: Fire.
        /// </summary>
        public string DamageResistances { get; set; } = string.Empty;

        /// <summary>
        /// Gets or sets damage immunities belonging to the monster.  Example: Poison, Psychic; Bludgeoning, Piercing, and Slashing From Nonmagical Attacks That Aren't Adamantine.
        /// </summary>
        public string DamageImmunities { get; set; } = string.Empty;

        /// <summary>
        /// Gets or sets condition immunities belonging to the monster.  Example: Charmed, Exhaustion, Frightened, Paralyzed, Petrified, Poisoned.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a collection of special abilities associated with the monster.
        /// </summary>
        public List<MonsterSpecialAbility> SpecialAbilities { get; set; } = new List<MonsterSpecialAbility> { };

        /// <summary>
        /// Gets or sets a collection of actions associated with the monster.
        /// </summary>
        public List<MonsterAction> Actions { get; set; } = new List<MonsterAction> { };

        /// <summary>
        /// Gets or sets a collection of reactions associated with the monster.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a collection of legendary actions associated with the monster.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets monster data formatted in standard text format.
        /// </summary>
        [JsonIgnore]
        public string TextStatBlock { get; set; } = string.Empty;

        /// <summary>
        /// Gets or sets monster data formatted in standard CL format.
        /// </summary>
        [JsonIgnore]
        public string CLStatBlock { get; set; } = string.Empty;

        /// <summary>
        /// Gets or sets monster data formatted in JSON format.
        /// </summary>
        [JsonIgnore]
        ...
        public string ToTextStatBlock()
        {
            ...
            _ = builder.AppendLine($"{this.Name}");
            _ = builder.AppendLine($"{this.Size} {this.Type}, {this.Alignment}");
            _ = builder.AppendLine($"Armor Class {this.ArmorClass} ({this.ArmorDesc})");
            _ = builder.AppendLine($"Hit Points {this.HitPoints} ({this.HitDice})");
            ...
            _ = builder.AppendLine($"Speed {string.Join(", ", speeds)}");
            _ = builder.AppendLine($"STR {this.Strength} ({ConvertBonusToSignedString(CalculateAbilityBonus(this.Strength))})");
            _ = builder.AppendLine($"DEX {this.Dexterity} ({ConvertBonusToSignedString(CalculateAbilityBonus(this.Dexterity))})");
            _ = builder.AppendLine($"CON {this.Constitution} ({ConvertBonusToSignedString(CalculateAbilityBonus(this.Constitution))})");
            _ = builder.AppendLine($"INT {this.Intelligence} ({ConvertBonusToSignedString(CalculateAbilityBonus(this.Intelligence))})");
            _ = builder.AppendLine($"WIS {this.Wisdom} ({ConvertBonusToSignedString(CalculateAbilityBonus(this.Wisdom))})");
            _ = builder.AppendLine($"CHA {this.Charisma} ({ConvertBonusToSignedString(CalculateAbilityBonus(this.Charisma))})");
            ...
            {
                _ = builder.AppendLine($"Saving Throws {string.Join(", ", savingThrows)}");
            }
            ...
            {
                _ = builder.AppendLine($"Skills {string.Join(", ", skillsList)}");
            }

            if (!string.IsNullOrEmpty(this.DamageVulnerabilities))
            {
                _ = builder.AppendLine($"Damage Vulnerabilities {this.DamageVulnerabilities}");
            }

            if (!string.IsNullOrEmpty(this.DamageResistances))
            {
                _ = builder.AppendLine($"Damage Resistances {this.DamageResistances}");
            }

            if (!string.IsNullOrEmpty(this.DamageImmunities))
            {
                _ = builder.AppendLine($"Damage Immunities {this.DamageImmunities}");
            }

            if (!string.IsNullOrEmpty(this.ConditionImmunities))
            {
                _ = builder.AppendLine($"Condition Immunities {this.ConditionImmunities}");
            }
            ...
            _ = builder.AppendLine($"Senses {string.Join(", ", sensesList)}");
            if (!string.IsNullOrEmpty(this.Languages))
            {
                _ = builder.AppendLine($"Languages {this.Languages}");
            }

            _ = builder.AppendLine($"Challenge {ConvertChallengeRatingToString(this.ChallengeRating)} ({CalculateExperiencePoints(this.ChallengeRating)} XP)");
            _ = builder.AppendLine($"Proficiency Bonus {ConvertBonusToSignedString(CalculateProficiencyBonus(this.ChallengeRating))}");
            if (this.SpecialAbilities != null && this.SpecialAbilities.Count > 0)
            {
                foreach (MonsterSpecialAbility specialAbility in this.SpecialAbilities)
                {
                    _ = builder.AppendLine($"{specialAbility.Name}. {specialAbility.Description}");
                }
            }

            if (this.Actions != null && this.Actions.Count > 0)
            {
                _ = builder.AppendLine("Actions");
                foreach (MonsterAction action in this.Actions)
                {
                    _ = builder.AppendLine($"{action.Name}. {action.Description}");
                }
            }

            if (this.LegendaryActions != null && this.LegendaryActions.Count > 0)
            {
                _ = builder.AppendLine("Legendary Actions");
                _ = builder.AppendLine($"{this.LegendaryActionDescription}");
                foreach (MonsterLegendaryAction action in this.LegendaryActions)
                {
                    _ = builder.AppendLine($"{action.Name}. {action.Description}");
                }
            }
        ...
        {
            StringBuilder builder = new ();
            _ = builder.AppendLine($"```clyt");
            _ = builder.AppendLine($"template: stat-block.5e");
            _ = builder.AppendLine($"title: {this.Name}");
            _ = builder.AppendLine($"description: {this.Size} {this.Type}, {this.Alignment}");
            ...
            _ = builder.AppendLine($"- Speed: {string.Join(", ", speeds)}");
            _ = builder.AppendLine($"- abilities:");
            _ = builder.AppendLine($"     STR: {this.Strength} ({ConvertBonusToSignedString(CalculateAbilityBonus(this.Strength))})");
            _ = builder.AppendLine($"     DEX: {this.Dexterity} ({ConvertBonusToSignedString(CalculateAbilityBonus(this.Dexterity))})");
            _ = builder.AppendLine($"     CON: {this.Constitution} ({ConvertBonusToSignedString(CalculateAbilityBonus(this.Constitution))})");
            _ = builder.AppendLine($"     INT: {this.Intelligence} ({ConvertBonusToSignedString(CalculateAbilityBonus(this.Intelligence))})");
            ...
            if (this.SpecialAbilities != null && this.SpecialAbilities.Count > 0)
            {
                _ = builder.AppendLine("traits:");
                foreach (MonsterSpecialAbility specialAbility in this.SpecialAbilities)
                {
                    _ = builder.AppendLine($"- {specialAbility.Name}: >");
            ...
            if (this.Actions != null && this.Actions.Count > 0)
            {
                ...
                foreach (MonsterAction action in this.Actions)
                {
                    _ = builder.AppendLine($"- {action.Name}: >");
            ...
            {
                _ = builder.AppendLine($"- Reactions: The {this.Name} has the following reactions.");
                foreach (MonsterReaction reaction in this.Reactions)
                {
                    _ = builder.AppendLine($"- {reaction.Name}: >");
            ...
            if (this.LegendaryActions != null && this.LegendaryActions.Count > 0)
            {
                _ = builder.AppendLine($"- Legendary Actions: {this.LegendaryActionDescription}");
                foreach (MonsterLegendaryAction legendaryAction in this.LegendaryActions)
                {
                    _ = builder.AppendLine($"-  {legendaryAction.Name}: >");
